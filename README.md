...
- The Data directory contains the data supporting the results in the paper. The Alpha subdirectory contains the spin interaction files (saved as "`<index_spin_1`> `<index_spin_2`> `<interaction`>"), while the Omega subdirectory contains the results of the runs of the annealings: each row of the file contains a different run and is in the form
